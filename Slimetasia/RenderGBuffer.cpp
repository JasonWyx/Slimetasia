...
void RenderGBuffer::DestroyDescriptors() {}

void RenderGBuffer::CreateRenderPass() {}

void RenderGBuffer::DestroyRenderPass() {}
...
void RenderGBuffer::CreateFramebuffers() 
{
    ...
    m_GBufferImages.push_back(
        ImageObject::CreateImage(vk::Format::eD24UnormS8Uint, extent, vk::ImageUsageFlagBits::eDepthStencilAttachment, vk::ImageViewType::e2D, vk::ImageAspectFlagBits::eDepth | vk::ImageAspectFlagBits::eStencil, false, nullptr));
